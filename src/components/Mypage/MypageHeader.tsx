...
const MypageHeader: React.FC = () => {
    return (
        <div>
            <header className="sticky top-0 z-50 h-[68px] flex w-full items-center justify-between py-3 px-5 bg-white">
                <Link to="/">
                    <button type="button" className="inline-flex select-none items-center justify-center gap-5xs rounded-lg px-3 py-3 text-base font-medium disabled:cursor-not-allowed bg-transparent disabled:text-gray-50 w-fit min-w-fit !p-0">
                ...
                <p className="whitespace-pre-line text-wrap text-[20px] font-bold leading-[155%]">마이페이지</p>
